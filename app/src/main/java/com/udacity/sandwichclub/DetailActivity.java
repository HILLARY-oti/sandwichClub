...
public class DetailActivity extends AppCompatActivity {
    ...
    private void populateUI(Sandwich sandwich) {
        ...
        if (sandwich.getAlsoKnownAs().isEmpty()) {
            ...
            List<String> anotherName = sandwich.getAlsoKnownAs();
            String another_str = TextUtils.join(", ", anotherName);
            alsoKnown.setText(another_str);
        }

        description.setText(sandwich.getDescription());

        List<String> you = sandwich.getIngredients();
        String you_str = TextUtils.join(", ", you);
        ingredients.setText(you_str);
    }
}